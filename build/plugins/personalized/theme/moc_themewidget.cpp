...
#include "../../../../plugins/personalized/theme/themewidget.h"
...
void ThemeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ThemeWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThemeWidget::clicked)) {
                *result = 0;
                return;
            }
        }

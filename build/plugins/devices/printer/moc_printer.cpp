...
#include "../../../../plugins/devices/printer/printer.h"
...
QT_MOC_LITERAL(1, 8, 17), // "refreshPrinterDev"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "Printer\0refreshPrinterDev\0"
};
...
void Printer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->refreshPrinterDev(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    'a',  'c',  'e', 
    // "className"
    0x03,  0x67,  'P',  'r',  'i',  'n',  't',  'e', 
    'r', 
    0xff, 
};
QT_MOC_EXPORT_PLUGIN(Printer, Printer)

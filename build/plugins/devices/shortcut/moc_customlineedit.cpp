...
#include "../../../../plugins/devices/shortcut/customlineedit.h"
...
QT_MOC_LITERAL(1, 15, 19), // "shortcutCodeSignals"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 10) // "QList<int>"

    },
    "CustomLineEdit\0shortcutCodeSignals\0\0"
    "QList<int>"
};
...
void CustomLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->shortcutCodeSignals((*reinterpret_cast< QList<int>(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (CustomLineEdit::*)(QList<int> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomLineEdit::shortcutCodeSignals)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomLineEdit::shortcutCodeSignals(QList<int> _t1)
{

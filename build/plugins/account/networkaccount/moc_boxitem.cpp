...
#include "../../../../plugins/account/networkaccount/boxitem.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BoxItem_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject BoxItem::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_BoxItem.data,
    qt_meta_data_BoxItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *BoxItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BoxItem.stringdata0))
